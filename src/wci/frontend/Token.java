...
public class Token {
    protected TokenType type; // language-specifictoken type
    ...
    /**
     * Constructor.
     * @param source the source from where to fetch the token's chracters.
     ...
     * Subclasses can override this method to construct language-specific tokens. After extracting the token,
     * the current source line position will be one beyond the last token character.
     * @throws Exception if an error occurred.
     */
